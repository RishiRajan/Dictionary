[
  {
    ...
    phonetics: [
      {
        text: "/haɪ/",
        audio:
          "https://api.dictionaryapi.dev/media/pronunciations/en/hi-1-uk.mp3",
        sourceUrl: "https://commons.wikimedia.org/w/index.php?curid=9021999",
        license: {
          name: "BY 3.0 US",
      ...
      },
      {
        text: "/haɪ/",
        audio:
          "https://api.dictionaryapi.dev/media/pronunciations/en/hi-1-us.mp3",
        sourceUrl: "https://commons.wikimedia.org/w/index.php?curid=1221246",
        license: {
          name: "BY-SA 3.0",
    ...
    meanings: [
      {
        ...
        definitions: [
          {
            definition: 'The word "hi" used as a greeting.',
            synonyms: [],
            antonyms: [],
      ...
      },
      {
        ...
        definitions: [
          ...
          {
            definition: "An exclamation to call attention.",
            synonyms: [],
            antonyms: [],
          },
          {
            definition: "Expressing wonder or derision.",
            synonyms: [],
            antonyms: [],
          },
        ],
    ...
    sourceUrls: ["https://en.wiktionary.org/wiki/hi"],
  },
  {
    word: "hi",
    phonetics: [],
